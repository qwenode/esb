...
func Term(field string, value types.FieldValue) QueryOption {
...
func Terms(field string, values ...types.FieldValue) QueryOption {
    return func(q *types.Query) {
...
func TermsSlice(field string, values []types.FieldValue) QueryOption {
    return func(q *types.Query) {
        q.Terms = &types.TermsQuery{
            TermsQuery: map[string]types.TermsQueryField{
                field: values,
